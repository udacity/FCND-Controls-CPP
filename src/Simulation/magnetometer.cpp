...
void magnetometer::magnetometer_sensor(float declination, V3F &mag_measurement){
  mag = V3F(0.215212f,0.002806f,-0.42741f); // Values taken from SITLGazebo PX4 (WMM 2015) NED Frame, order 10^5 nT
